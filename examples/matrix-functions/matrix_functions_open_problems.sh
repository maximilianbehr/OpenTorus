#!/usr/bin/env bash
# ============================================================================
# OpenTorus example — limited-memory polynomial methods for matrix functions
# Source: "Limited-memory polynomial methods for large-scale matrix functions"
#          (Güttel, Kressner, Lund; arXiv:2002.01682)
#
# Sets up one dossier per open problem (from the bundled notes.md) and lets the
# agent attack a chosen target with literature + its own numerical experiments.
#
...
#   3. build the python-sci container for the Krylov / matrix-function experiments
...
#   - the bundled notes.md (five problems)
#
# WARNING: step 1 runs `rm -rf .opentorus` in this directory.
# Usage: ./matrix_functions_open_problems.sh [PROBLEM-ID]   (defaults to PROBLEM-0001)
# ============================================================================
set -euo pipefail
cd "$(dirname "$0")"
...
opentorus paper add https://arxiv.org/abs/2002.01682
